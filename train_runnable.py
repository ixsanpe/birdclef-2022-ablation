...
def parse_args():
    ...
    parser.add_argument('--k_runs', type=int, default=1, help='Number of splits for cross validation. Default to 1. Current implementation only support 1 and 3')
...
def main():
    args = parse_args()
    print(args)
    if args.k_runs not in [1,3]:
        raise Exception(f'k_runs = {args.k_runs} is currently not supported. Choose either 1 or 3')
